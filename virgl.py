...
def install_rootfs():
    os.makedirs("/data/data/com.termux/files/home/proot-distro", exist_ok=True)
    os.makedirs("/data/data/com.termux/files/home/proot-distro/installed-rootfs", exist_ok=True)
    os.makedirs("/data/data/com.termux/files/home/proot-distro/installed-rootfs/ubuntu", exist_ok=True)
